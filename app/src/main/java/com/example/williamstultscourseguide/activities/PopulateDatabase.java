...
public class PopulateDatabase extends AppCompatActivity {
    ...
    public void insertAssessments() {
        ...
        tempAssessment1.setAssessment_due(due.getTime());
        tempAssessment1.setAssessment_goal(goal.getTime());
        tempAssessment1.setAssessment_title("Jelly Exam");
        ...
        tempAssessment1.setAssessment_due(due.getTime());
        tempAssessment1.setAssessment_goal(goal.getTime());
        tempAssessment1.setAssessment_title("My Conspiracy Theory");
        tempAssessment1.setAssessment_type("Performance");
    ...
    public void insertCoursementors() {
        ...
        tempCourseMentor1.setCoursementor_name("Tim Horton");
        tempCourseMentor1.setCoursementor_email("thorton@stults.edu");
        tempCourseMentor1.setCoursementor_phone("555-444-3333");
        tempCourseMentor1.setCourse_id_fk(courseList.get(1).getCourse_id());

        tempCourseMentor1.setCoursementor_name("Alex Trump");
        tempCourseMentor1.setCoursementor_email("atrump@stults.edu");
        tempCourseMentor1.setCoursementor_phone("555-222-8888");
